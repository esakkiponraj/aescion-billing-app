      ...
      <div className="bg-white w-full max-w-md rounded-lg shadow-xl border border-[#E2E8F0] overflow-hidden animate-in fade-in zoom-in-95">
        <div className="bg-[#F8FAFC] border-b border-[#E2E8F0] px-5 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#64748B]">Authorized Platform & Workspace Access</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSignIn} className="p-5 space-y-3.5 bg-white text-xs">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-2.5 px-4 bg-[#2563EB] hover:bg-[#1D4ED8] active:bg-[#1E40AF] text-white font-semibold text-xs rounded-md shadow-sm flex items-center justify-center space-x-1.5 transition mt-2 cursor-pointer"
          >
          ...
          <div className="text-center pt-2 border-t border-[#EDF1F5]">
            <span className="text-[11px] text-[#64748B]">New enterprise business? </span>
            <button
              type="button"
